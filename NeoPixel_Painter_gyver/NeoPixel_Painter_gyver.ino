/*
   ...
   Strt - (Start) начало работы, инициализация SD карты. Эту надпись можно успеть прочитать только при запуске в режиме загрузки
...
// ----------------------- ПОДКЛЮЧЕНИЕ -----------------------
#define CLK_ENC 2  // ПИН ЭНКОДЕРА
#define DT_ENC 3   // ПИН ЭНКОДЕРА
#define SW_ENC 4   // ПИН ЭНКОДЕРА

#define CLK 7      // ДИСПЛЕЙ
#define DIO 8      // ДИСПЛЕЙ

#define LED_PIN 6  // пин DIN ленты
#define TRIGGER 5  // кнопка запуска анимации
